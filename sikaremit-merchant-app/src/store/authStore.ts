...
interface AuthState {
  ...
  register: (data: { email: string; password: string; first_name: string; last_name: string; phone: string; business_name?: string; business_type?: string }) => Promise<{ message: string }>;
