...
// Simple currency implementation for this page to avoid auth dependency
const useSimpleCurrency = () => {
  ...
  const convertAmount = (amount: number, fromCurrency?: string, toCurrency?: string) => {
    // Simple conversion - in real app this would use exchange rates
    return amount
  }
  const currency = 'GHS'
  
  return { formatAmount, convertAmount, currency }
}
import {
  Dialog,
  DialogContent,
...
export default function MerchantPayoutsPage() {
  return (
    <AuthGuard>
      <MerchantPayoutsPageContent />
    </AuthGuard>
  )
}

function MerchantPayoutsPageContent() {
  ...
  const { formatAmount, convertAmount, currency } = useSimpleCurrency()
