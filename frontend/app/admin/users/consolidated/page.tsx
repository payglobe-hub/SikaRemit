...
export default function ConsolidatedUserManagementPage() {
  const [showAdvancedFilters, setShowAdvancedFilters] = useState(false)
  
  // Use the shared hook with excludeAdmins=true by default for general user management
  ...
  return (
    <div className="w-full space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-slate-600 mt-1 text-base">
            Manage all users on the platform with advanced filtering and search capabilities
          </p>
        </div>
      ...
      <UserDialogs
        ...
        isDeleting={isDeleting}
        showAdminOptions={false} // General user management doesn't allow admin creation
      />
    </div>
  )
}
